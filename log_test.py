...
import pandas as pd
btcdf=pd.read_csv('/Users/ric/Desktop/git_resume/Untitled/da/data/Bitcoin.csv', sep=',', header='infer')
#print(btcdf.values)

ethdf=pd.read_csv('/Users/ric/Desktop/git_resume/Untitled/da/data/Ethereum.csv', sep=',', header='infer')
#print(ethdf.values)
